  ...
  return (
    <section className="relative overflow-hidden bg-rose-light py-24 md:py-32">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <motion.div
          className="bg-white/40 backdrop-blur-xl border border-white/60 rounded-[3rem] p-8 md:p-16 shadow-xl"
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-20">
            <div className="flex-1 text-center md:text-left">
              <span className="text-chocolate/60 text-xs font-semibold tracking-[0.3em] uppercase font-sans">Tu fecha se viene</span>
              ...
              <p className="text-chocolate/80 font-sans font-light mt-4 text-lg leading-relaxed max-w-md mx-auto md:mx-0">
                Los pedidos se confirman con anticipación. Si tenés un festejo en puerta, no esperes, ¡escribime ahora y reservo tu fecha!
              </p>
              <a
